...
annotate service.Products with @(
  ...
  UI.LineItem : [
    ...
    { $Type: 'UI.DataField', Value: categoryName,  Label: '분류', ![@HTML5.CssDefaults]: { width: 'auto' } },
...
annotate service.Inventories with @(
  ...
  UI.LineItem : [
    { $Type: 'UI.DataField', Value: productCode,    Label: '상품 코드', ![@HTML5.CssDefaults]: { width: 'auto' } },
    { $Type: 'UI.DataField', Value: productName,     Label: '상품명', ![@HTML5.CssDefaults]: { width: 'auto' } },
  ...
  UI.FieldGroup #InventoryInfo : {
    ...
    Data  : [
      ...
      { $Type: 'UI.DataField', Value: availableQty,  Label: '가용 수량', Criticality: criticality },
  ...
  UI.FieldGroup #ProductInfo : {
    ...
    Data  : [
      ...
      { $Type: 'UI.DataField', Value: productCode,   Label: '상품 코드' },
      { $Type: 'UI.DataField', Value: productName,    Label: '상품명' },
      { $Type: 'UI.DataField', Value: safetyStock,   Label: '안전 재고' }
    ]
  },
...
annotate service.PurchaseOrders with @(
  UI.HeaderInfo : {
    ...
    Description    : { $Type: 'UI.DataField', Value: productName }
  },
  ...
  UI.FieldGroup #ApprovalInfo : {
    $Type : 'UI.FieldGroupType',
    Data  : [
      { $Type: 'UI.DataField', Value: status,       Label: '상태', Criticality: criticality },
